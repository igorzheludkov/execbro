        ...
        "get_usage_guide",
        {
            ...
            inputSchema: {
                topic: z
                    ...
                    .optional()
                    .describe(
                        "Topic to get the full guide for. Available topics: setup, inspect, layout, interact, logs, network, state, bundle, feedback. Omit to see the overview of all topics."
                    )
            }
        },
        async ({ topic }) => {
