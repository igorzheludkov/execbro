...
- Use `mcp__execbro__scan_metro` — this automatically finds Metro on common ports (8081, 8082, 19000–19002) and connects
- If Metro is on a non-standard port, use `mcp__execbro__connect_metro` with the specific `port`
